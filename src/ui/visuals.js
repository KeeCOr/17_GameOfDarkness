...
export const UI_ASSETS = Object.freeze({
  ...
  gameBottomHudFrame: Object.freeze({ key: 'ui_game_bottom_hud_frame', path: 'assets/ui/game-bottom-hud-frame.png', type: 'image' }),
  ...
  gameBoardCellLight: Object.freeze({ key: 'ui_game_board_cell_light', path: 'assets/ui/game-board-cell-light.png', type: 'image' }),
  gameBoardCellDark: Object.freeze({ key: 'ui_game_board_cell_dark', path: 'assets/ui/game-board-cell-dark.png', type: 'image' }),
  gameBoardFogCell: Object.freeze({ key: 'ui_game_board_fog_cell', path: 'assets/ui/game-board-fog-cell.png', type: 'image' }),
  gameCellHighlightMove: Object.freeze({ key: 'ui_game_cell_highlight_move', path: 'assets/ui/game-cell-highlight-move.png', type: 'image' }),
  gameCellHighlightSelected: Object.freeze({ key: 'ui_game_cell_highlight_selected', path: 'assets/ui/game-cell-highlight-selected.png', type: 'image' }),
  gameCellHighlightMovable: Object.freeze({ key: 'ui_game_cell_highlight_movable', path: 'assets/ui/game-cell-highlight-movable.png', type: 'image' }),
  gameCellHighlightThreat: Object.freeze({ key: 'ui_game_cell_highlight_threat', path: 'assets/ui/game-cell-highlight-threat.png', type: 'image' }),
  gameCellHighlightSummon: Object.freeze({ key: 'ui_game_cell_highlight_summon', path: 'assets/ui/game-cell-highlight-summon.png', type: 'image' }),
...
export const UI_COPY = Object.freeze({
  ...
  hints: {
    ...
    summonRemaining: '이동 완료. 소환은 선택이며 지금 턴 종료도 가능합니다',
  ...
  help: {
    ...
    lines: [
      ...
      '소환하지 않아도 턴 종료를 눌러 AI에게 넘길 수 있습니다.',
    ],
    close: '확인',
  },
  tutorial: {
